...
@Autowired
    ...
    @GetMapping("/make-favourite")
    public String makeFavourite(@RequestParam("id")String id,@AuthenticationPrincipal Principal principal){
        FilmServiceModel filmServiceModel=this.filmService.findById(id);
        this.userService.addToFavourite(filmServiceModel,principal.getName());
        return "redirect:/home";
    }
